        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(itemId == R.id.nav_home) {
                    Navigation.findNavController(container).navigate(R.id.action_alertsFragment_to_homeFragment);
                }else if(itemId == R.id.nav_notifications) {
                    Navigation.findNavController(container).navigate(R.id.action_refresh_alerts_fragment);
                }else if(itemId == R.id.nav_chats) {
                    Navigation.findNavController(container).navigate(R.id.action_alertsFragment_to_chatsFragment);
                }else if(itemId == R.id.nav_calendar) {
                    Navigation.findNavController(container).navigate(R.id.action_alertsFragment_to_calendarFragment);
                }
                return true;
            }
        });
