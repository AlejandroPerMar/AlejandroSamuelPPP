...
import es.iespuertodelacruz.alejandrosamuel.studycircle.databinding.ActivitySidenavBinding;
...
public class Sidenav extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_sidenav);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.sidenav, menu);
        return true;
    }
