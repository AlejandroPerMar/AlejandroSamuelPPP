...
public enum RespuestasRegister {
    ...
    NOT_MINIMUN_REQUIREMENTS_PASSWORD ("NOT_MINIMUN_REQUIREMENTS_PASSWORD", "La contraseña debe tener entre 8 y 20 caracteres, minúsculas, mayúsculas y caracteres especiales"),
