...
import es.iespuertodelacruz.alejandrosamuel.studycircle.infrastructure.adapter.secondary.mapper.AlumnoPostEntityMapper;
...
public class AlumnoEntityService implements IAlumnoRepository {
	...
	public Alumno create(Alumno alumno) {
		AlumnoPostEntityMapper mapper = new AlumnoPostEntityMapper();
